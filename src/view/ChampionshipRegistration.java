...
//		        	listPlayersText.removeIf(String::isEmpty);
		...
		DefaultTableModel model = new DefaultTableModel() { public boolean isCellEditable(int rowIndex, int mColIndex){ return false; } };
	        ...
	        public void mouseClicked(MouseEvent e){
	            ...
	            int i = table.getSelectedRow();
	        	String namePlayer = model.getValueAt(i, 1).toString();
	        	String nicknamePlayer = model.getValueAt(i, 2).toString();
	            
	        	namePlayerText.setText(namePlayer);
	            nicknamePlayerText.setText(nicknamePlayer);
	        }
	        });
	        ...
	        btnUpdate.addActionListener(new ActionListener(){
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                if(i >= 0) 
	                {
	                   model.setValueAt(namePlayer, i, 1);
	                   model.setValueAt(nicknamePlayerText.getText(), i, 2);
	                   players.get(i).setName(nicknamePlayerText.getText());
	                   players.get(i).setNickname(nicknamePlayer);
	                }
	                else{
